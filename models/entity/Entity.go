...
type Users struct {
	...
	UserroleId int       `json:"userrole_id"` // Intentionally not defining a foreign key constraint
...
type Siswa struct {
	...
	TahunAjaranID int       `json:"tahun_ajaran_id"` // Intentionally not defining a foreign key constraint
